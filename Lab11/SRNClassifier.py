...
class SRNClassifier:
    ...
    def __init__(self, hidden_layer_size=100, activation='tanh', solver='adam',
        ...
        # Initialise parameters for the sgd optimiser
        self.momentum = 0.9

        # Initialise parameters for the adam optimiser
        self._adam_t = 0
        self._adam_B1 = 0.9
        self._adam_B2 = 0.999
        self._adam_eps = 1e-8
    ...
    def _slice_params(self, params):
        ...
        # Return the parameters split into layred weight matrices and bias vectors
    ...
    def fit(self, X, y):
        ...
        for i in range(self.max_iter):
            ...
            while(batch_index_start < N):
                ...
                # Backpropagation trough time of the error, starting at the last sample
                for n in reversed(range(batch_index_end-batch_index_start)):
                    ...
                    # Compute the blame on the context for the preceding sample
    ...
    # Compute the output of the model as probability distribution
    #
    # Input: X - an NxM matrix of N input of M-dimensions each, or a M-dimensional vector representing a single input
    #
    # Returns: y - an NxK matrix of outputs, or a K-dimensional vector representing a single output
    ...
    # Compute the output of the model as one hot-encoded decision
    #
    # Input: x - an NxM matrix of N input of M-dimensions each, or a M-dimensional vector representing a single input
    #
    # Returns: y - an NxK matrix of outputs, or a K-dimensional vector representing a single output
    def predict(self,X):
        ...
        # If input was in vector format, convert the matrix output to a vector
        if _vec_input:
